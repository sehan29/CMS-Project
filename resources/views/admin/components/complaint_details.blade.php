        ...
        <div class="row">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-center mb-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $complaint->user->name }}
                                        </div>
                                ...
                                <div class="d-flex align-items-center mb-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            {{ $complaint->user->passport_nic ?? 'N/A' }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0">
                                                    ...
                                                    @elseif($complaint->isReconsideration())
                                                        <span class="badge badge-danger">Reconsideration</span>
                                ...
                                <div class="card border-left-danger">
                                    <div class="card-body">
                                        @foreach ($complaint->reconsiderationNotes as $note)
                                            <div class="mb-4">
                                                <div class="text-muted mb-2">
                                                    <span class="badge badge-secondary pt-2">Request
                        ...
                        <div class="alert alert-success shadow-sm rounded-3 p-4">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    <h5 class="mb-3 fw-semibold text-success">User Rating</h5>
                                    <div class="mb-2">
                                        @for ($i = 1; $i <= 5; $i++)
                                            <i class="fas fa-star{{ $i <= $complaint->rating ? ' text-warning' : ' text-muted' }} me-1"></i>
                                        @endfor
                                    </div>
                        
                                    @if ($complaint->feedback)
                                        <div class="mb-2">
                                            <h6 class="fw-semibold mb-1 text-dark">User Feedback</h6>
                                            <p class="mb-1 text-secondary">{{ $complaint->feedback }}</p>
                                            <small class="text-muted">
                                                Last Updated: {{ $complaint->updated_at->setTimezone('Asia/Colombo')->format('F j, Y · h:i A') }}
                                            </small>
                                        </div>
                                    @endif
                                </div>
                        
                                <span class="badge bg-success fs-6 align-self-start py-2 text-white">Submitted</span>
                            </div>
                        </div>
                        @endif
            ...
            <div class="col-xl-4 col-lg-5">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        @if ($complaint->isPending())
                            <button class="btn btn-primary btn-icon-split btn-block mb-3 assign-btn" data-toggle="modal"
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <div class="mb-3">
                                    <span
                                        class="badge badge-{{ $complaint->priority === 'high' ? 'danger' : ($complaint->priority === 'medium' ? 'warning' : 'success') }}">
                                    ...
                                    <div class="col-6 mb-3">
                                        <div class="attachment-card">
                                            <a href="{{ asset('storage/' . $document->file_path) }}"
                                                data-toggle="lightbox" data-gallery="attachment-gallery">
                                                <div class="attachment-thumbnail">
                                                    ...
                                                    @else
                                                        <div class="file-icon">
                                                            <i
                                                                class="fas fa-file-{{ $document->file_type_icon }} fa-3x"></i>
                                                        </div>
                                                    @endif
                                                </div>
                                                <div class="attachment-info">
                                                    <small
                                                        class="text-truncate d-block">{{ $document->file_name }}</small>
                                                    <small
                                                        class="text-muted">{{ $document->created_at->format('M d, Y') }}</small>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                ...
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="assignModalLabel">
                        ...
                        @if ($complaint->isReconsideration())
                            Reassign Complaint #COMP-{{ $complaint->id }}
                        @else
                ...
                <form action="{{ route('admin.complaints.assign', $complaint) }}" method="POST">
                    ...
                    <div class="modal-body">
                        @if ($complaint->isReconsideration())
                            <div class="alert alert-warning">
                                ...
                                This complaint has been reconsidered. Please review the notes above before reassigning.
                            </div>
                        @endif
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectpicker" id="division" name="division" required
                                        data-live-search="true">
                                        <option value="">Select Division</option>
                                        <option value="Tourist Police"
                                            {{ $complaint->division == 'Tourist Police' ? 'selected' : '' }}>Tourist Police
                                        </option>
                                        <option value="Immigration"
                                            {{ $complaint->division == 'Immigration' ? 'selected' : '' }}>Immigration
                                        </option>
                                        <option value="Customs" {{ $complaint->division == 'Customs' ? 'selected' : '' }}>
                                            Customs</option>
                                        <option value="Other" {{ $complaint->division == 'Other' ? 'selected' : '' }}>
                                            Other</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectpicker" id="priority" name="priority" required>
                                        <option value="low" {{ $complaint->priority == 'low' ? 'selected' : '' }}>Low
                                            Priority</option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="notes" name="notes" rows="4"
                                placeholder="Enter any special instructions for the division...">{{ $complaint->notes }}</textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary">
                            @if ($complaint->isReconsideration())
                                <i class="fas fa-sync-alt mr-2"></i> Reassign Complaint
                            @else
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.complaints.note', $complaint) }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <textarea class="form-control" id="complaintNotes" name="note" rows="8"
                                placeholder="Enter your notes about this complaint...">{{ $complaint->notes }}</textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
